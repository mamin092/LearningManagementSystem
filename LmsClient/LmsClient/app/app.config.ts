module  App  {
    ...
    class Configuration {
        static $inject = ["$stateProvide", "$urlRouterProvide"];
        constructor(stateProvide: angular.ui.IStateProvider, urlRouteProvider: angular.ui.IUrlRouterProvider) {

            urlRouteProvider.otherwise("/");
            stateProvide.state("root", {
